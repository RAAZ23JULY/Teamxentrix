...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("paralleluniversw")
                await self.one.join_chat("xentrixbots")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("paralleluniversw")
                await self.two.join_chat("xentrixbots")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("paralleluniversw")
                await self.three.join_chat("xentrixbots")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("paralleluniversw")
                await self.five.join_chat("paralleluniversw")
            except:
                pass
            assistants.append(5)
